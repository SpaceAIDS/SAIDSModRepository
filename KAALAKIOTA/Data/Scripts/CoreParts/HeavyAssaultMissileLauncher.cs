    ...
    partial class Parts {
        ...
        WeaponDefinition HeavyAssaultMissileLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyAssaultMissileLauncher", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "muzzle_missile_1",
                    "muzzle_missile_1.001",
                    "muzzle_missile_1.002",
                    "muzzle_missile_1.003",
                    "muzzle_missile_1.004",
                    "muzzle_missile_1.005",
                    "muzzle_missile_1.006",
                    "muzzle_missile_1.007",
                    "muzzle_missile_1.008",
                    "muzzle_missile_1.009",
            ...
            {
                PartName = "Light Missile Launcher", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RotateRate = 0.35f, // Max traversal speed of azimuth subpart in radians per tick (0.1 is approximately 360 degrees per second).
                    ElevateRate = 0.35f, // Max traversal speed of elevation subpart in radians per tick.
                    MinAzimuth = -180,
                    MaxAzimuth = 180,
                    MinElevation = -9,
                    MaxElevation = 50,
