...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HeavyPulse => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HeavyPulse", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Heavy Pulse Laser", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
