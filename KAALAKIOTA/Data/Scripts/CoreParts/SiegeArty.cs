...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition PrototypeSiegeArtillery => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "PrototypeSiegeArtillery", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Siege Artillery", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "artysound", // Audio for firing.
            ...
            Ammos = new[] {
                Prey, Victim, Sacrifice, fragment_siege,
