...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition QuadArtilleryBase => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "QuadArtilleryBase", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Ammos = new[] {
                Quake, Tremor, Shatter, PhasedPlasma,
