...
{ // Don't edit above this line
    partial class Parts
    {
                ...
                private AmmoDef Scourge => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "PurpleAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Scourge Light Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
         ...
         private AmmoDef MjolnirLML => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "PurpleAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Mjolnir Light Missile", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1600f, // Direct damage; one steel plate is worth 100.
            Mass = 100f, // In kilograms; how much force the impact will apply to the target.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    Armor = -1000f, // Multiplier for damage against all armor. This is multiplied with the specific armor type multiplier (light, heavy).
                    Light = -1f, // Multiplier for damage against light armor.
                    Heavy = -1f, // Multiplier for damage against heavy armor.
                    NonArmor = 0.3f, // Multiplier for damage against every else.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 1f, //
                        Color = Color(red: 3, green: 35, blue: 55f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
