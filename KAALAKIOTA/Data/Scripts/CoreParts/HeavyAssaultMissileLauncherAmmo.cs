...
{ // Don't edit above this line
    partial class Parts
    {
                ...
                private AmmoDef Inferno => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "PurpleAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Inferno HAM", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Sync = new SynchronizeDef
            {
                ...
                OnHitDeath = true, // Server will inform clients when projectiles die due to them hittiang something and will trigger destruction.
            },
            ...
            {
                AmmoRound = "fragment_ham", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossTime = 360, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                AccelPerSec = 370, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 1f, //
                        Color = Color(red: 105, green: 35, blue: 35f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        ...
                        Segmentation = new SegmentDef
                        {
                            ...
                            Color = Color(red: 55, green: 35, blue: 35f, alpha: 1),
                            WidthMultiplier = 1f,
                            Reverse = false,
         ...
         private AmmoDef NovaHAM => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "PurpleAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Nova HAM", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1600f, // Direct damage; one steel plate is worth 100.
            Mass = 100f, // In kilograms; how much force the impact will apply to the target.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "MissileExplosion_M8", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "MyAssaultHit", // SubtypeID from your Audio SBC, not a filename
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                },
            },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2f, //
                        Width = 1f, //
                        Color = Color(red: 115, green: 115, blue: 35f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
            ...
            private AmmoDef fragment_ham => new AmmoDef
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "fragment_ham", // Name of ammo in terminal, should be different for each ammo type used by the same weapon.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 5f,
                        Color = Color(red: 10, green: 2, blue: 0, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine",
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 120,
                        Color = Color(red: 50, green: 2, blue: 0, alpha: 1),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = false,
                        UseColorFade = true,
