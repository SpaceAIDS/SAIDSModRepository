...
namespace Scripts
{
    partial class Parts
    {
        internal Parts()
        {
            ...
            PartDefinitions(Coil250,HeavyPulse,QuadArtilleryBase,QuadBarrelAutocannon,B8T_Flare,HeavyTorpedoLauncher,DualBarrelArtillery,PrototypeSiegeArtillery,LightMissileLauncher);
            ArmorDefinitions();
            SupportDefinitions();
            UpgradeDefinitions();
        }
