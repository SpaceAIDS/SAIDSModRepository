...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SG_Vulcan_AutoCannon_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SG_Vulcan_AutoCannon_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "SGVulcanAutoCannonUpDown", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "SGVulcanAutoCannonLeftRight", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "SGVulcanAutoCannonUpDown",// Your Elevating Subpart, that bit that moves up
            ...
            Ammos = new[] {
                SG_Vulcan_AutoCannon_Ammo, 
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = SG_Vulcan_AutoCannon_Animation,
