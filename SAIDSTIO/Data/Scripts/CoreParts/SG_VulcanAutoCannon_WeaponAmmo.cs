...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SG_Vulcan_AutoCannon_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "SG_Vulcan_AutoCannon_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SG_Vulcan_AutoCannon_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "ArcWepPlayRifleImpGrassAlien3d02",
                ShotSound = "",
                ShieldHitSound = "ArcSmShipSmJetHydrogenEnd3d",
                PlayerHitSound = "ArcWepPlayRifleImpGrassAlien3d02",
                VoxelHitSound = "ArcWepPlayRifleImpGrassAlien3d02",
                FloatingHitSound = "",
                HitPlayChance = 0.5f,
                HitPlayShield = true,
            },
