...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Depleted_Uranium_Slugs_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Depleted Uranium Slugs Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
 ...
 private AmmoDef Magnetic_Slugs_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
     ...
     HybridRound = false, // Use both a physical ammo magazine and energy per shot.
     EnergyCost = 0.2f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
     BaseDamage = 750, // Direct damage; one steel plate is worth 100.
     ...
     DamageScales = new DamageScaleDef
            {
                ...
                FallOff = new FallOffDef
                {
                    ...
                    MinMultipler = 0.20f, // Value from 0.0001f to 1f where 0.1f would be a min damage of 10% of base damage.
                },
                Grids = new GridSizeDef
                {
                    Large = -1f, // Multiplier for damage against large grids.
         ...
         Custom = new CustomScalesDef
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 2000f, // voxel phasing if you go above 5100
         ...
         Particles = new AmmoParticleDef
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.2f, //
                        Width = 0.2f, //
                        Color = Color(red: 33, green: 28, blue: 24, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        AlwaysDraw = false, // Prevents this tracer from being culled.  Only use if you have a reason too (very long tracers/trails).
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 1, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 1, green: 2, blue: 10, alpha: 1),
                        FactionColor = DontUse, // DontUse, Foreground, Background.
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = false,
