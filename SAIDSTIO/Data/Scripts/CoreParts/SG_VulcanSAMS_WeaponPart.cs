...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SG_Vulcan_SAMS_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SG_Vulcan_SAMS_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "SGVulcanSAMSMIssleMuzzles", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "SGVulcanSAMSAzimuth", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "SGVulcanSAMSElevation",// Your Elevating Subpart, that bit that moves up
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Thrust,  // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
                ...
                MaxTargetDistance = 1000f, // Maximum distance at which targets will be automatically shot at; 0 = unlimited.
            ...
            {
                PartName = "Vulcan SAMS Turret", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "TorpFlyBy", // Audio for firing.
            ...
            Animations = SG_Vulcan_SAMS_Animation,
