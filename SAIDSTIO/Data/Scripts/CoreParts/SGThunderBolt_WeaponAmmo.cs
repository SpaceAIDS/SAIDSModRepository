...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef ThunderBoltGatlingGun_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "ThunderBoltGatlingGun_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 150, // Direct damage; one steel plate is worth 100.
            Mass = 2f, // In kilograms; how much force the impact will apply to the target.
            Health = 0, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            BackKickForce = 2f, // Recoil. This is applied to the Parent Grid.
