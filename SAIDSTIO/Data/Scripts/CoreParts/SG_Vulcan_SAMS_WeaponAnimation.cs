...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef SG_Vulcan_SAMS_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("SGVulcanSAMSMissle1"),
                    BarrelId = "muzzle_projectile_2", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 500, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
               ...
               new PartAnimationSetDef()
                {
                    SubpartId = Names("SGVulcanSAMSMissle2"),
