...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition ThunderBoltGatlingGun_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "ThunderBoltGatlingGun_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "M1-ThunderBolt-Gatling Gun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.150f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "ThunderboltGat", // Audio for firing.
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "ThunderBolt_Muzzle_Flash_Autocannon",
            ...
            Ammos = new[] {
                ThunderBoltGatlingGun_Ammo, 
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = ThunderBoltGatlingGun_Animation,
