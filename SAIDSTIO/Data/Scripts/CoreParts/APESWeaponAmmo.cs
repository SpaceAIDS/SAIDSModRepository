...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Laser_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 0.4f, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
 ...
 private AmmoDef AmmoType15 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Ammo 15", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
