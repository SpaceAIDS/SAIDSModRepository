...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef PDCTurret_Animation => new AnimationDef
        {
            ...
            AnimationSets = new[]
            {
                ...
                {
                    SubpartId = Names("PDCBarrelSpin"),
                    BarrelId = "Any", //only used for firing, use "Any" for all muzzles
                    StartupFireDelay = 60,
                    AnimationDelays = Delays(FiringDelay : 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 100, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0, StopFiringDelay: 0, StopTrackingDelay:0, InitDelay:0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(),
