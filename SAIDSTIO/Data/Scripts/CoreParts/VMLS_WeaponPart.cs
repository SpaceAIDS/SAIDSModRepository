    ...
    partial class Parts {
        ...
        WeaponDefinition VMLS_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "VMLS_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "VXM-08 Multi Launch Missile System", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                VMLS_Ammo, SwarmVMLS_Ammo, VMLSShrap_Ammo, SwarmVMLSShrap_Ammo,
