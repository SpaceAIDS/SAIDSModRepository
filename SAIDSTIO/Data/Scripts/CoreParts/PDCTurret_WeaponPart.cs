...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition PDCTurret_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "PDCTurret_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "PDCTurretEL", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "PDCTurretAZ", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "PDCTurretEL",// Your Elevating Subpart, that bit that moves up
            ...
            {
                Threats = new[] {
                    Projectiles, Meteors, Characters,  // Types of threat to engage: Grids, Projectiles, Characters, Meteors, Neutrals
                },
                SubSystems = new[] {
            ...
            {
                PartName = "XMA-41 Guardian PDS", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 1500, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    BarrelsPerShot = 1, // How many muzzles will fire a projectile per fire event.
                    TrajectilesPerBarrel = 1, // Number of projectiles per muzzle per fire event.
                    SkipBarrels = 0, // Number of muzzles to skip after each fire event.
                    ReloadTime = 60, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    MagsToLoad = 50, // Number of physical magazines to consume on reload.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "PDCBrrt", // Audio for firing.
            ...
            Ammos = new[] {
                ...
                Animations = PDCTurret_Animation,
