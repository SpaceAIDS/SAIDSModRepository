...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SG_Missile_Bay_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SG_Missile_Bay_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Archer Missile Launch Bay", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    InventorySize = 0.250f, // Inventory capacity in kL.
                ...
                Graphics = new HardPointParticleDef
                {
                    Effect1 = new ParticleDef
                    {
                        ...
                        Offset = Vector(x: 0, y: 6, z: 0), // Offsets the effect from the muzzle empty.
            ...
            Ammos = new[] {
                SG_Missile_Bay_Ammo, MissileShrap_Ammo,
                 // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = SG_Missile_Bay_Animation,
