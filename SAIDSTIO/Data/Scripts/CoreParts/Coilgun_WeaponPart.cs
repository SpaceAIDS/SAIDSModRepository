    ...
    partial class Parts {
        ...
        WeaponDefinition CoilgunMk2_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CoilgunMk2_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "M1-A2 Main Battery Coilgun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Depleted_Uranium_Slugs_Ammo, Magnetic_Slugs_Ammo,
