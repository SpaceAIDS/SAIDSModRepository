...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SG_TankCannon_Block => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SG_TankCannon_Block", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            Targeting = new TargetingDef
            {
                ...
                MaximumDiameter = 1250, // Maximum radius of threat to engage; 0 = unlimited.
            ...
            {
                PartName = "M42 Tank Gun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    IdlePower = 0.99f, // Constant base power draw in MW.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "Tank", // Audio for firing.
            ...
            Animations = SG_TankGun_Animation,
