...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SG_TankCannon_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "SG_TankCannon_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SG_TankCannon_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "TankImpact",
                ShotSound = "",
                ShieldHitSound = "TankImpact",
                PlayerHitSound = "TankImpact",
                VoxelHitSound = "TankImpact",
                FloatingHitSound = "TankImpact",
                HitPlayChance = 0.5f,
                HitPlayShield = true,
            },
