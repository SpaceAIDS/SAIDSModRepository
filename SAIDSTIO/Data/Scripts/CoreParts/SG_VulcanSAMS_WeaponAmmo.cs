...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SG_Vulcan_SAMS_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "SG_Vulcan_SAMS_MagazineLarge", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "SG_Vulcan_SAMS_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 9000f, // Distance at which damage begins falling off.
            ...
            {
                ModelName = "\\Models\\Ammo\\SG_Vulcan_SAMS_MIssle1.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                HitSound = "SGMissileImpact",
                ShotSound = "",
                ShieldHitSound = "SGMissileImpact",
                PlayerHitSound = "SGMissileImpact",
                VoxelHitSound = "SGMissileImpact",
                FloatingHitSound = "",
                HitPlayChance = 0.5f,
                HitPlayShield = true,
            },
