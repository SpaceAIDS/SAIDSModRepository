...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef PDCTurret_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "GreenAmmoMagDef", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "PDCTurret_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 0.21, // How much Health to subtract from another projectile on hit; defaults to 1 if zero or less.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.2f, //
                        Color = Color(red: 24, green: 16, blue: 8f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
