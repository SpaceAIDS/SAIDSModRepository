...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef WarpDisruptor => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Warp Disruptor",
            ...
            AmmoGraphics = new GraphicDef
{
    ...
    Lines = new LineDef
    {
        ...
        Tracer = new TracerBaseDef
        {
            ...
            Length = 0.5f, //
            Width = 0.25f, //
            Color = Color(red: 15f, green: 35f, blue: 45f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            ...
            Segmentation = new SegmentDef
            {
                ...
                Color = Color(red: 15, green: 45, blue: 55f, alpha: 0.1f),
                WidthMultiplier = 1f,
                Reverse = false,
        ...
        private AmmoDef PropJammer => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Nav. Disruptor",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 5f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 0f,
            Mass = 0, // in kilograms
            ...
            Ewar = new EwarDef
            {
                ...
                */
                Force = new PushPullDef
                {
                    ...
                    Position = HitPosition, // ProjectileLastPosition, ProjectileOrigin, HitPosition, TargetCenter, TargetCenterOfMass
                    DisableRelativeMass = false,
                    TractorRange = 1000,
                    ShooterFeelsForce = false,
                },
    ...
    Lines = new LineDef
    {
        ...
        OffsetEffect = new OffsetEffectDef
        {
            ...
            Ejection = new EjectionDef
            {
                ...
                private AmmoDef GunJammer => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Weapon Jammer",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 5f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 0f,
            Mass = 0, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
{
    ...
    Lines = new LineDef
    {
        ...
        Tracer = new TracerBaseDef
        {
            ...
            Length = 0.5f, //
            Width = 0.25f, //
            Color = Color(red: 45f, green: 15f, blue: 15f, alpha: 0.1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
            VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
            VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
            Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                "WeaponLaser", // Please always have this Line set, if this Section is enabled.
