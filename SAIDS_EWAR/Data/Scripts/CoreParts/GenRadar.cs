...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition StasisGrappler => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "TestEWAR_One", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "genradarelev", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "genradarazim", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "genradarelev",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.1f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
            ...
            {
                PartName = "Small Stasis Grappler", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    ShotsInBurst = 7200, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
                ...
                {
                    PreFiringSound = "ewarsfx", // Audio for warmup effect.
                    FiringSound = "ewarsfx", // Audio for firing.
                    FiringSoundPerShot = false, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "ewarsfx", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "ewarsfx",
