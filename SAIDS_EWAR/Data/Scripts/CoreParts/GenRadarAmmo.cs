...
namespace Scripts
{
    partial class Parts
    {
        private AmmoDef ThrusterJammer => new AmmoDef //Longest range, lowest dmg.
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Propulsion Jammer",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = .4f,
                        Color = Color(red: 25, green: 25f, blue: 25, alpha: 1f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 50,
                        Color = Color(red: 55f, green: 55f, blue: 55f, alpha: 1f),
                        Back = true,
                        CustomWidth = 0,
