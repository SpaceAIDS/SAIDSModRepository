        ...
        WeaponDefinition LargeBlockAssaultCannonTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 320, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Ammos = new[] {
                AssaultCannonShell, AssaultCannonShellAPBase,  // Must list all primary, shrapnel, and pattern ammos.
            },
