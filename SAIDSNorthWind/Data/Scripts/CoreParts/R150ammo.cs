...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef R150ammo => new AmmoDef
        {
            AmmoMagazine = "BlueAmmoMagDef",
            AmmoRound = "R150ammo",
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 440, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
                DesiredSpeed = 2500,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "Collision_Sparks", //ShipWelderArc
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 80f,
                        Width = 0.3f,
                        Color = Color(red: 45.0f, green: 15.20f, blue: 5.0f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        ...
                        DecayTime = 30,
                        Color = Color(red: 40.985f, green: 20.162f, blue: 5.81f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
        ...
        private AmmoDef railgunShrapnel2 => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "railgunShrapnel2",
        ...
        private AmmoDef railgunShrapnel2B => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "railgunShrapnel2B",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 80f,
            Mass = 0f, // in kilograms
        ...
        private AmmoDef RailFXshot => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RailFXshot",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1000f,
                        Width = 0.05f,
                        Color = Color(red: 25.0f, green: 25.20f, blue: 40.0f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 1.5,// 0 offset value disables this effect
                        MinLength = 3.2f,
                        MaxLength = 15,
                    },
                },
        ...
        private AmmoDef RailFXshot2 => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RailFXshot2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 500f,
                        Width = 0.03f,
                        Color = Color(red: 30.0f, green: 25.20f, blue: 18.0f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                    ...
                    OffsetEffect = new OffsetEffectDef
                    {
                        MaxOffset = 1.9,// 0 offset value disables this effect
                        MinLength = 1.2f,
                        MaxLength = 14,
                    },
                },
