...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef R250ammo => new AmmoDef
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 60f,
                        Width = 0.3f,
                        Color = Color(red: 50.0f, green: 25.20f, blue: 3.0f, alpha: 1f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
        ...
        private AmmoDef railgunShrapnel3 => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "railgunShrapnel3",
        ...
        private AmmoDef RailFXshotl => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RailFXshotl",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef RailFXshotl2 => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "RailFXshotl2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f,
            Mass = 0f, // in kilograms
